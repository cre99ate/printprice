...
class Ink {
    constructor( water, solvent, latex, uvW, uvC, uvCw, uvCwc, uvCc, uvBlack ){
        this.water = water;        
...
paper.대형텐트천 = new Ink();
    ...
    // 후레임 모드   :   0_출력만,   1_출력만(장폭),  2_제작,  3_제작(장폭),  4_출력(풀),  5_출력(풀-장폭),  6_제작(풀),  7_제작(풀-장폭)
...
paper.투명시트.uvW = [ 9000 ];
paper.투명시트.uvC = [ 9000 ];
paper.투명시트.uvCw = [ 12000 ];
paper.투명시트.uvCwc = [ 14000 ];
...
paper.엠보시트.uvW = [ 9000 ];
paper.엠보시트.uvC = [ 9000 ];
paper.엠보시트.uvCw = [ 12000 ];
paper.엠보시트.uvCwc = [ 14000 ];

//고투명PET(유광점착]
paper.고투명점착시트.uvW = [ 9000 ];
paper.고투명점착시트.uvC = [ 9000 ];
paper.고투명점착시트.uvCw = [ 12000 ];
paper.고투명점착시트.uvCwc = [ 14000 ];

//고투명PET(비점착]
paper.고투명비점착시트.uvW = [ 9000 ];
paper.고투명비점착시트.uvC = [ 9000 ];
paper.고투명비점착시트.uvCw = [ 12000 ];
paper.고투명비점착시트.uvCwc = [ 14000 ];

//LG타공썬팅시트 lg50000
paper.타공썬팅시트.solvent = [ 27000, 32000, 32000, 32000, 64000 ];
paper.타공썬팅시트.latex = [ 27000, 32000, 32000, 32000, 64000 ];
paper.타공썬팅시트.uvC = [ 27000 ];

//LG타공채널시트 lg5300W
paper.타공채널시트.solvent = [ 27000, 32000, 32000, 32000, 64000 ];
paper.타공채널시트.latex = [ 27000, 32000, 32000, 32000, 64000 ];
paper.타공채널시트.uvC = [ 27000 ];
...
paper.조명후렉스.solvent = [ 5000, 9000, 4000, 8000, 6000, 10000, 5000, 9000 ];
paper.조명후렉스.latex = [ 7000, 11000, 6000, 10000, 8000, 12000, 7000, 11000 ];
...
//그레이후렉스 
paper.비조명후렉스.solvent = [ 5000, 9000, 4000, 8000, 6000, 10000, 5000, 9000 ];
paper.비조명후렉스.latex = [ 7000, 11000, 6000, 10000, 8000, 12000, 7000, 11000 ];
...
function findPrice( sheet, mode ) {
    ...
    let price_water, price_solvent, price_latex;
    let price_uvW, price_uvC, price_uvCw;
    let price_uvCwc, price_uvCc, price_uvBlack;
    
    try{
        let water = paper[sheet]['water'][mode];
        water === NaN || water === undefined
            ? price_water = 0    
            : price_water = water
    }catch(e){
        price_water = 0
